...
String sql2 = "INSERT INTO `homekart`.`user` (`name`, `mobile`, `adress`, `area`, `gender`,`points`, `password`) VALUES ( '"+name+"', '"+mobile+"', '"+address+"', '"+area+"', '"+gen+"','0', '"+password+"');";
stmt.executeUpdate(sql2);
ResultSet rs = stmt.executeQuery("SELECT id FROM `homekart`.`user` ORDER BY user.id DESC LIMIT 1;");
while(rs.next())
{
cid=rs.getString(1);
}
